...
const populateStates = (countryElementId, stateElementId) => {
    const selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    ...
    const state_arr = s_a[selectedCountryIndex].split("|");
...
const populateCountries = (countryElementId, stateElementId) => {
