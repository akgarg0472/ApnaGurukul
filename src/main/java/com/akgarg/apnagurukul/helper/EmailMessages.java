...
public class EmailMessages {
    ...
    public static String profileUpdatedMessage(String email, String name) {
        return "Dear " + "<strong>" + name + "</strong>," +
                "<br><br>" +
                "Greetings from team ApnaGurukul!!" +
                "<br><br>" +
                "It is to inform you that your profile with username " + maskEmail(email) + " is " +
                "successfully updated." +
                "<br>" +
                "If you have not perform this action, then please change password of your account immediately." +
                "<br><br>" +
                "Thanks" +
                "<br>" +
                "Regards" +
    ...
    public static String contactQueryMessage(ContactUs contactUs) {
        return "Attention" +
                "<br><br>" +
                "New contact us query:" +
                "<br>" +
                "<strong>Name: </strong>" + contactUs.getFirstName() + " " + contactUs.getLastName() +
                "<br>" +
                "<strong>Email: </strong>" + contactUs.getEmail() +
                "<br>" +
                "<strong>Query message: </strong>" + contactUs.getDescription() +
                "<br><br>" +
                "Thanks" +
                "<br>" +
                "Regards" +
    ...
    private static String maskEmail(String email) {
        ...
        if (indexOfAt > 3) {
            final int maskLen = Math.min(Math.max(indexOfAt / 2, 2), 7);
